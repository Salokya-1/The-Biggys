  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        ...
        const Text('KramIQ', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
        const SizedBox(height: 2),
        const Text('Developed by The Biggys', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
