...
const STATUS_STYLE: Record<StudentStatus, string> = {
  ...
  DEFERRED: 'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200',
...
const STANDING_STYLE: Record<Standing, string> = {
  ...
  RESIT: 'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200',
...
const SHEET_STYLE: Record<MarkSheetStatus, string> = {
  ...
  CORRECTION_REQUESTED: 'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200',
};
